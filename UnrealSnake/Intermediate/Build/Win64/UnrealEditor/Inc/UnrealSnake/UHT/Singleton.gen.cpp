...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASingletonActor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Singletons/Singleton.h" },
		{ "ModuleRelativePath", "Public/Singletons/Singleton.h" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_UnrealSnake_Source_UnrealSnake_Public_Singletons_Singleton_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_UnrealSnake_Source_UnrealSnake_Public_Singletons_Singleton_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASingletonActor, ASingletonActor::StaticClass, TEXT("ASingletonActor"), &Z_Registration_Info_UClass_ASingletonActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASingletonActor), 3671297406U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_UnrealSnake_Source_UnrealSnake_Public_Singletons_Singleton_h_848707651(TEXT("/Script/UnrealSnake"),
		Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_UnrealSnake_Source_UnrealSnake_Public_Singletons_Singleton_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_UnrealSnake_Source_UnrealSnake_Public_Singletons_Singleton_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
