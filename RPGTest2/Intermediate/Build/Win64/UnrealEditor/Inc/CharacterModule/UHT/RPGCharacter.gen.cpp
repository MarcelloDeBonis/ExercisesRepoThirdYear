...
#include "CharacterModule/Public/Character/RPGCharacter.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeRPGCharacter() {}
// Cross Module References
	CHARACTERMODULE_API UClass* Z_Construct_UClass_ARPGCharacter();
	CHARACTERMODULE_API UClass* Z_Construct_UClass_ARPGCharacter_NoRegister();
...
// End Cross Module References
	...
	template<> CHARACTERMODULE_API UClass* StaticClass<ARPGCharacter>()
	{
		return ARPGCharacter::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ARPGCharacter);
	ARPGCharacter::~ARPGCharacter() {}
	struct Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_RPGTest2_Source_CharacterModule_Public_Character_RPGCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_RPGTest2_Source_CharacterModule_Public_Character_RPGCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARPGCharacter, ARPGCharacter::StaticClass, TEXT("ARPGCharacter"), &Z_Registration_Info_UClass_ARPGCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARPGCharacter), 2849546735U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_RPGTest2_Source_CharacterModule_Public_Character_RPGCharacter_h_1820175748(TEXT("/Script/CharacterModule"),
		Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_RPGTest2_Source_CharacterModule_Public_Character_RPGCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Marce_OneDrive_Desktop_Work_ExercisesRepoThirdYear_RPGTest2_Source_CharacterModule_Public_Character_RPGCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
