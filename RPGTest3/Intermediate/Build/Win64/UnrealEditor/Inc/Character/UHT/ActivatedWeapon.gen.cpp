...
// Cross Module References
	CHARACTER_API UClass* Z_Construct_UClass_UActivatedWeapon();
	CHARACTER_API UClass* Z_Construct_UClass_UActivatedWeapon_NoRegister();
	CHARACTER_API UClass* Z_Construct_UClass_UWeaponState();
	UPackage* Z_Construct_UPackage__Script_Character();
// End Cross Module References
	void UActivatedWeapon::StaticRegisterNativesUActivatedWeapon()
	{
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UActivatedWeapon);
	UClass* Z_Construct_UClass_UActivatedWeapon_NoRegister()
	{
		return UActivatedWeapon::StaticClass();
	}
	struct Z_Construct_UClass_UActivatedWeapon_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UActivatedWeapon_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UWeaponState,
		(UObject* (*)())Z_Construct_UPackage__Script_Character,
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActivatedWeapon_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActivatedWeapon_Statics::Class_MetaDataParams[] = {
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UActivatedWeapon_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UActivatedWeapon>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActivatedWeapon_Statics::ClassParams = {
		&UActivatedWeapon::StaticClass,
		nullptr,
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActivatedWeapon_Statics::Class_MetaDataParams), Z_Construct_UClass_UActivatedWeapon_Statics::Class_MetaDataParams)
	};
	UClass* Z_Construct_UClass_UActivatedWeapon()
	{
		if (!Z_Registration_Info_UClass_UActivatedWeapon.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UActivatedWeapon.OuterSingleton, Z_Construct_UClass_UActivatedWeapon_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UActivatedWeapon.OuterSingleton;
	}
	template<> CHARACTER_API UClass* StaticClass<UActivatedWeapon>()
	{
		return UActivatedWeapon::StaticClass();
	}
