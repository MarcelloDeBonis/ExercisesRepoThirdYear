...
// Cross Module References
	CHARACTER_API UClass* Z_Construct_UClass_UDeactivatedWeapon();
	CHARACTER_API UClass* Z_Construct_UClass_UDeactivatedWeapon_NoRegister();
	CHARACTER_API UClass* Z_Construct_UClass_UWeaponState();
	UPackage* Z_Construct_UPackage__Script_Character();
// End Cross Module References
	void UDeactivatedWeapon::StaticRegisterNativesUDeactivatedWeapon()
	{
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UDeactivatedWeapon);
	UClass* Z_Construct_UClass_UDeactivatedWeapon_NoRegister()
	{
		return UDeactivatedWeapon::StaticClass();
	}
	struct Z_Construct_UClass_UDeactivatedWeapon_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UDeactivatedWeapon_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UWeaponState,
		(UObject* (*)())Z_Construct_UPackage__Script_Character,
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDeactivatedWeapon_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDeactivatedWeapon_Statics::Class_MetaDataParams[] = {
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UDeactivatedWeapon_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UDeactivatedWeapon>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDeactivatedWeapon_Statics::ClassParams = {
		&UDeactivatedWeapon::StaticClass,
		nullptr,
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDeactivatedWeapon_Statics::Class_MetaDataParams), Z_Construct_UClass_UDeactivatedWeapon_Statics::Class_MetaDataParams)
	};
	UClass* Z_Construct_UClass_UDeactivatedWeapon()
	{
		if (!Z_Registration_Info_UClass_UDeactivatedWeapon.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UDeactivatedWeapon.OuterSingleton, Z_Construct_UClass_UDeactivatedWeapon_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UDeactivatedWeapon.OuterSingleton;
	}
	template<> CHARACTER_API UClass* StaticClass<UDeactivatedWeapon>()
	{
		return UDeactivatedWeapon::StaticClass();
	}
